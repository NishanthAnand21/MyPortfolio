let github = "https://github.com/NishanthAnand21";
let linkedIn = "https://www.linkedin.com/in/nishanth-anand-59ab96217/"
...
social = [
  ...
  'github         <a href="' +
    github +
    '" target="_blank">github/NishanthAnand21' +
    "</a>",
  'linkedin       <a href="' +
    linkedIn +
    '" target="_blank">linkedIn.com/nishanth-anand-59ab96217/' +
    "</a>",
  'email          <a href="mailto:nishanthanand817@gmail.com" target="_blank">email/Nishanth-Anand' +
    "</a>",
  'discord        <a href="https://discordapp.com/users/242001354468491274" target="_blank">discord/Nishanth-Anand' +
    "</a>",
  "<br>",
];
...
projects = [
  ...
  "All projects are visable on my <a href='https://github.com/NishanthAnand21/' target='_blank'>GitHub",
  "<br>",
